<x-layout>
    ...
    <section class="row bg-blue d-flex justify-content-center align-items-center mt-5">
        
        <div class="col-12 col-md-6 col-lg-4 text-center">
            
            <h1 class="display-4 mt-5 form-title">Registrati</h1>
            
            <form class="p-4 p-md-5 login-form mb-5" action="{{ route('register') }}" method="POST">
                @csrf
                ...
                <p class="mt-3">
                    Sei già registrato ? fai login da qui
                    <a href="{{ route('login') }}">Accedii</a>
                </p>
